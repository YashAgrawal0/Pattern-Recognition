...
MEAN,COVARIANCE,PI = findMCP("train_class1.txt",MEAN,COVARIANCE,PI)
MEAN,COVARIANCE,PI = findMCP("train_class2.txt",MEAN,COVARIANCE,PI)
MEAN,COVARIANCE,PI = findMCP("train_class3.txt",MEAN,COVARIANCE,PI)
...
c1w1,dim = input("test_class1.txt")
c1w2,dim = input("test_class2.txt")
c1w3,dim = input("test_class3.txt")
