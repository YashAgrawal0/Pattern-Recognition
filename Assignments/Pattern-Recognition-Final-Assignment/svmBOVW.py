...
train_datapoints,length1 = input("DATA/BOVW/train_class1.txt",train_datapoints)
train_datapoints,length2 = input("DATA/BOVW/train_class2.txt",train_datapoints)
train_datapoints,length3 = input("DATA/BOVW/train_class3.txt",train_datapoints)
...
test_datapoints,length1 = input("DATA/BOVW/test_class1.txt",test_datapoints)
test_datapoints,length2 = input("DATA/BOVW/test_class2.txt",test_datapoints)
test_datapoints,length3 = input("DATA/BOVW/test_class3.txt",test_datapoints)
