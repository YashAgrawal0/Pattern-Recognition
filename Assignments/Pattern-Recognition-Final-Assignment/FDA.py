...
class1_datapoints = input("DATA/NLS/class1.txt")
class2_datapoints = input("DATA/NLS/class2.txt")
class3_datapoints = input("DATA/NLS/class3.txt")
...
class1_Testdatapoints = inputTestData("DATA/NLS/class1.txt")
class2_Testdatapoints = inputTestData("DATA/NLS/class2.txt")
class3_Testdatapoints = inputTestData("DATA/NLS/class3.txt")
